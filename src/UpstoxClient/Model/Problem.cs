...
namespace UpstoxClient.Model
{
    ...
    public partial class Problem
    {
        ...
        [JsonConstructor]
        public Problem(Option<string?> message = default, Option<string?> errorCode = default, Option<string?> propertyPath = default, Option<Object?> invalidValue = default)
        {
    ...
    public class ProblemJsonConverter : JsonConverter<Problem>
    {
        ...
        public override Problem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Problem(message, errorCode, propertyPath, invalidValue);
        }
        ...
        {
            if (problem.MessageOption.IsSet)
                if (problem.MessageOption.Value != null)
                    writer.WriteString("message", problem.Message);
                else
                    writer.WriteNull("message");

            if (problem.ErrorCodeOption.IsSet)
                if (problem.ErrorCodeOption.Value != null)
                    writer.WriteString("error_code", problem.ErrorCode);
                else
                    writer.WriteNull("error_code");

            if (problem.PropertyPathOption.IsSet)
                if (problem.PropertyPathOption.Value != null)
                    writer.WriteString("property_path", problem.PropertyPath);
                else
                    writer.WriteNull("property_path");

            if (problem.InvalidValueOption.IsSet)
                if (problem.InvalidValueOption.Value != null)
                {
                    writer.WritePropertyName("invalid_value");
                    JsonSerializer.Serialize(writer, problem.InvalidValue, jsonSerializerOptions);
                }
                else
