...
namespace UpstoxClient.Model
{
    ...
    public partial class LogoutResponse
    {
        ...
        /// <param name="data">Logout status</param>
        [JsonConstructor]
        public LogoutResponse(Option<StatusEnum?> status = default, Option<bool?> data = default)
        {
            StatusOption = status;
            DataOption = data;
            OnCreated();
        ...
        /// Logout status
        /// </summary>
        /// <value>Logout status</value>
        [JsonPropertyName("data")]
        public bool? Data { get { return this.DataOption; } set { this.DataOption = new(value); } }
    ...
    public class LogoutResponseJsonConverter : JsonConverter<LogoutResponse>
    {
        ...
        public override LogoutResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<LogoutResponse.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<LogoutResponse.StatusEnum?>(LogoutResponse.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "data":
            ...
            return new LogoutResponse(status, data);
        }
        ...
        {
            var statusRawValue = LogoutResponse.StatusEnumToJsonValue(logoutResponse.StatusOption.Value!.Value);
            if (statusRawValue != null)
                writer.WriteString("status", statusRawValue);
            else
                writer.WriteNull("status");

            if (logoutResponse.DataOption.IsSet)
                if (logoutResponse.DataOption.Value != null)
                    writer.WriteBoolean("data", logoutResponse.DataOption.Value!.Value);
                else
