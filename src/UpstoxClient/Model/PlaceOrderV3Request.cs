...
namespace UpstoxClient.Model
{
    ...
    /// PlaceOrderV3Request
    /// </summary>
    public partial class PlaceOrderV3Request
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaceOrderV3Request" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Used to track the state of Slice
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> SliceOption { get; private set; }

        /// <summary>
        /// Gets or Sets Slice
        /// </summary>
        [JsonPropertyName("slice")]
        public bool? Slice { get { return this.SliceOption; } set { this.SliceOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlaceOrderV3Request" />
    /// </summary>
    public class PlaceOrderV3RequestJsonConverter : JsonConverter<PlaceOrderV3Request>
    {
        /// <summary>
        /// Deserializes json to <see cref="PlaceOrderV3Request" />
        /// </summary>
        ...
        public override PlaceOrderV3Request Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PlaceOrderV3Request.ProductEnum?> product = default;
            Option<PlaceOrderV3Request.ValidityEnum?> validity = default;
            Option<float?> price = default;
            Option<string?> tag = default;
            Option<bool?> slice = default;
            Option<string?> instrumentToken = default;
            Option<PlaceOrderV3Request.OrderTypeEnum?> orderType = default;
            Option<PlaceOrderV3Request.TransactionTypeEnum?> transactionType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "product":
                            ...
                            if (productRawValue != null)
                                product = new Option<PlaceOrderV3Request.ProductEnum?>(PlaceOrderV3Request.ProductEnumFromStringOrDefault(productRawValue));
                            break;
                        case "validity":
                            string? validityRawValue = utf8JsonReader.GetString();
                            if (validityRawValue != null)
                                validity = new Option<PlaceOrderV3Request.ValidityEnum?>(PlaceOrderV3Request.ValidityEnumFromStringOrDefault(validityRawValue));
                            break;
                        case "price":
                        ...
                        case "order_type":
                            ...
                            if (orderTypeRawValue != null)
                                orderType = new Option<PlaceOrderV3Request.OrderTypeEnum?>(PlaceOrderV3Request.OrderTypeEnumFromStringOrDefault(orderTypeRawValue));
                            break;
                        case "transaction_type":
                            string? transactionTypeRawValue = utf8JsonReader.GetString();
                            if (transactionTypeRawValue != null)
                                transactionType = new Option<PlaceOrderV3Request.TransactionTypeEnum?>(PlaceOrderV3Request.TransactionTypeEnumFromStringOrDefault(transactionTypeRawValue));
                            break;
            ...
            if (!quantity.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(quantity));

            if (!product.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(product));

            if (!validity.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(validity));

            if (!price.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(price));

            if (!instrumentToken.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(instrumentToken));

            if (!orderType.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(orderType));

            if (!transactionType.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(transactionType));

            if (!disclosedQuantity.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(disclosedQuantity));

            if (!triggerPrice.IsSet)
                throw new ArgumentException("Property is required for class PlaceOrderV3Request.", nameof(triggerPrice));
        ...
        /// <summary>
        /// Serializes a <see cref="PlaceOrderV3Request" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="placeOrderV3Request"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlaceOrderV3Request placeOrderV3Request, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, placeOrderV3Request, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlaceOrderV3Request" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="placeOrderV3Request"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlaceOrderV3Request placeOrderV3Request, JsonSerializerOptions jsonSerializerOptions)
        {
            if (placeOrderV3Request.Quantity != null)
                writer.WriteNumber("quantity", placeOrderV3Request.Quantity.Value);
            else
                writer.WriteNull("quantity");

            var productRawValue = PlaceOrderV3Request.ProductEnumToJsonValue(placeOrderV3Request.Product!.Value);
            if (productRawValue != null)
                writer.WriteString("product", productRawValue);
            else
                writer.WriteNull("product");

            var validityRawValue = PlaceOrderV3Request.ValidityEnumToJsonValue(placeOrderV3Request.Validity!.Value);
            if (validityRawValue != null)
                writer.WriteString("validity", validityRawValue);
            else
                writer.WriteNull("validity");

            if (placeOrderV3Request.Price != null)
                writer.WriteNumber("price", placeOrderV3Request.Price.Value);
            else
                writer.WriteNull("price");

            if (placeOrderV3Request.TagOption.IsSet)
                if (placeOrderV3Request.TagOption.Value != null)
                    writer.WriteString("tag", placeOrderV3Request.Tag);
                else
                    writer.WriteNull("tag");

            if (placeOrderV3Request.SliceOption.IsSet)
                if (placeOrderV3Request.SliceOption.Value != null)
                    writer.WriteBoolean("slice", placeOrderV3Request.SliceOption.Value!.Value);
                else
                    writer.WriteNull("slice");

            if (placeOrderV3Request.InstrumentToken != null)
                writer.WriteString("instrument_token", placeOrderV3Request.InstrumentToken);
            else
                writer.WriteNull("instrument_token");

            var orderTypeRawValue = PlaceOrderV3Request.OrderTypeEnumToJsonValue(placeOrderV3Request.OrderType!.Value);
            if (orderTypeRawValue != null)
                writer.WriteString("order_type", orderTypeRawValue);
            else
                writer.WriteNull("order_type");

            var transactionTypeRawValue = PlaceOrderV3Request.TransactionTypeEnumToJsonValue(placeOrderV3Request.TransactionType!.Value);
            if (transactionTypeRawValue != null)
                writer.WriteString("transaction_type", transactionTypeRawValue);
            else
                writer.WriteNull("transaction_type");

            if (placeOrderV3Request.DisclosedQuantity != null)
                writer.WriteNumber("disclosed_quantity", placeOrderV3Request.DisclosedQuantity.Value);
            else
                writer.WriteNull("disclosed_quantity");

            if (placeOrderV3Request.TriggerPrice != null)
                writer.WriteNumber("trigger_price", placeOrderV3Request.TriggerPrice.Value);
            else
                writer.WriteNull("trigger_price");

            if (placeOrderV3Request.IsAmo != null)
