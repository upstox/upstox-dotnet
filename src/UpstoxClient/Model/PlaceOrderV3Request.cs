...
namespace UpstoxClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlaceOrderV3Request :  IEquatable<PlaceOrderV3Request>, IValidatableObject
    {
        /// <summary>
        ...
        public PlaceOrderV3Request(int? quantity = default(int?), ProductEnum product = default(ProductEnum), ValidityEnum validity = default(ValidityEnum), float? price = default(float?), string tag = default(string), bool? slice = default(bool?), string instrumentToken = default(string), OrderTypeEnum orderType = default(OrderTypeEnum), TransactionTypeEnum transactionType = default(TransactionTypeEnum), int? disclosedQuantity = default(int?), float? triggerPrice = default(float?), bool? isAmo = default(bool?))
        {
            // to ensure "quantity" is required (not null)
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
            ...
            if (product == null)
            {
                throw new InvalidDataException("product is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
            ...
            if (validity == null)
            {
                throw new InvalidDataException("validity is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
                this.Price = price;
            ...
            {
                throw new InvalidDataException("instrumentToken is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
            ...
            if (orderType == null)
            {
                throw new InvalidDataException("orderType is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("transactionType is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("disclosedQuantity is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("triggerPrice is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
            ...
            if (isAmo == null)
            {
                throw new InvalidDataException("isAmo is a required property for PlaceOrderV3Request and cannot be null");
            }
            else
            {
                this.IsAmo = isAmo;
        ...
        {
            return this.Equals(input as PlaceOrderV3Request);
        }

        /// <summary>
        /// Returns true if PlaceOrderV3Request instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaceOrderV3Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceOrderV3Request input)
        {
            if (input == null)
                return false;
