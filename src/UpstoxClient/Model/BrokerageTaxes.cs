...
namespace UpstoxClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BrokerageTaxes :  IEquatable<BrokerageTaxes>, IValidatableObject
    {
        /// <summary>
        ...
        public BrokerageTaxes(float? gst = default(float?), float? stt = default(float?), float? stampDuty = default(float?))
        {
            this.Gst = gst;
            this.Stt = stt;
        ...
        {
            return this.Equals(input as BrokerageTaxes);
        }

        /// <summary>
        /// Returns true if BrokerageTaxes instances are equal
        /// </summary>
        /// <param name="input">Instance of BrokerageTaxes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrokerageTaxes input)
        {
            if (input == null)
                return false;
