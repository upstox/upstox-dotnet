...
inputSpec: https://api.upstox.com/v2/api-docs
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{F9905AFC-6E7C-4D57-966A-3076FE30B7FD}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IChargeApi>();
            IGetBrokerageApiResponse apiResponse = await api.GetBrokerageAsync("todo");
            GetBrokerageResponse? model = apiResponse.Ok();
        }
