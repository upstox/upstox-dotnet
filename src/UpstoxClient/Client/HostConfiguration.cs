...
namespace UpstoxClient.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            // New converters for Fundamentals, History, IPO, Instruments, MutualFund, News, UserExtensions
            _jsonOptions.Converters.Add(new AnalyticsResponseJsonConverter());
            _jsonOptions.Converters.Add(new AvailableToTradeJsonConverter());
            _jsonOptions.Converters.Add(new BalanceSheetDataJsonConverter());
            _jsonOptions.Converters.Add(new BalanceSheetHistoryItemJsonConverter());
            _jsonOptions.Converters.Add(new BalanceSheetResponseJsonConverter());
            _jsonOptions.Converters.Add(new CashAvailableToTradeJsonConverter());
            _jsonOptions.Converters.Add(new CashBreakdownJsonConverter());
            _jsonOptions.Converters.Add(new CashFlowDataJsonConverter());
            _jsonOptions.Converters.Add(new CashFlowEntryJsonConverter());
            _jsonOptions.Converters.Add(new CashFlowResponseJsonConverter());
            _jsonOptions.Converters.Add(new CashMarginUsedJsonConverter());
            _jsonOptions.Converters.Add(new CashUnavailableToTradeJsonConverter());
            _jsonOptions.Converters.Add(new CompanyProfileDataJsonConverter());
            _jsonOptions.Converters.Add(new CompanyProfileResponseJsonConverter());
            _jsonOptions.Converters.Add(new CompetitorDataJsonConverter());
            _jsonOptions.Converters.Add(new CompetitorsResponseJsonConverter());
            _jsonOptions.Converters.Add(new CorporateActionDataJsonConverter());
            _jsonOptions.Converters.Add(new CorporateActionEventDetailJsonConverter());
            _jsonOptions.Converters.Add(new CorporateActionsResponseJsonConverter());
            _jsonOptions.Converters.Add(new DeliveryMarginJsonConverter());
            _jsonOptions.Converters.Add(new FamilyMemberDataJsonConverter());
            _jsonOptions.Converters.Add(new FinancialStatementEntryJsonConverter());
            _jsonOptions.Converters.Add(new GetMutualFundHoldingsResponseJsonConverter());
            _jsonOptions.Converters.Add(new GetMutualFundOrderDetailsResponseJsonConverter());
            _jsonOptions.Converters.Add(new GetMutualFundOrdersResponseJsonConverter());
            _jsonOptions.Converters.Add(new GetMutualFundSipsResponseJsonConverter());
            _jsonOptions.Converters.Add(new GetNewsResponseJsonConverter());
            _jsonOptions.Converters.Add(new GetUserFundMarginV3ResponseJsonConverter());
            _jsonOptions.Converters.Add(new HistoryItemJsonConverter());
            _jsonOptions.Converters.Add(new IncomeStatementDataJsonConverter());
            _jsonOptions.Converters.Add(new IncomeStatementEntryJsonConverter());
            _jsonOptions.Converters.Add(new IncomeStatementResponseJsonConverter());
            _jsonOptions.Converters.Add(new IpoApplyDataJsonConverter());
            _jsonOptions.Converters.Add(new IpoApplyRequestJsonConverter());
            _jsonOptions.Converters.Add(new IpoApplyResponseJsonConverter());
            _jsonOptions.Converters.Add(new IpoBidRequestJsonConverter());
            _jsonOptions.Converters.Add(new IpoCancelDataJsonConverter());
            _jsonOptions.Converters.Add(new IpoCancelResponseJsonConverter());
            _jsonOptions.Converters.Add(new IpoDetailsDataJsonConverter());
            _jsonOptions.Converters.Add(new IpoDetailsResponseJsonConverter());
            _jsonOptions.Converters.Add(new IpoInvestorTypeJsonConverter());
            _jsonOptions.Converters.Add(new IpoListingDataJsonConverter());
            _jsonOptions.Converters.Add(new IpoListingResponseJsonConverter());
            _jsonOptions.Converters.Add(new IpoMetaDataJsonConverter());
            _jsonOptions.Converters.Add(new IpoOrderBidJsonConverter());
            _jsonOptions.Converters.Add(new IpoOrderDataJsonConverter());
            _jsonOptions.Converters.Add(new IpoOrderDetailResponseJsonConverter());
            _jsonOptions.Converters.Add(new IpoOrderResponseJsonConverter());
            _jsonOptions.Converters.Add(new IpoRegistrarInfoJsonConverter());
            _jsonOptions.Converters.Add(new IpoTimelineJsonConverter());
            _jsonOptions.Converters.Add(new KeyRatioDataJsonConverter());
            _jsonOptions.Converters.Add(new KeyRatiosResponseJsonConverter());
            _jsonOptions.Converters.Add(new KillSwitchResponseJsonConverter());
            _jsonOptions.Converters.Add(new KillSwitchSegmentDataJsonConverter());
            _jsonOptions.Converters.Add(new KillSwitchSegmentUpdateRequestJsonConverter());
            _jsonOptions.Converters.Add(new LossJsonConverter());
            _jsonOptions.Converters.Add(new MarginFromPledgeJsonConverter());
            _jsonOptions.Converters.Add(new MutualFundHoldingDataJsonConverter());
            _jsonOptions.Converters.Add(new MutualFundMetaDataJsonConverter());
            _jsonOptions.Converters.Add(new MutualFundOrderDataJsonConverter());
            _jsonOptions.Converters.Add(new MutualFundSipDataJsonConverter());
            _jsonOptions.Converters.Add(new NewsItemDataJsonConverter());
            _jsonOptions.Converters.Add(new NewsResponseMetaDataJsonConverter());
            _jsonOptions.Converters.Add(new NewsResponsePageDataJsonConverter());
            ...
            _jsonOptions.Converters.Add(new SearchInstrumentResponseJsonConverter());
            _jsonOptions.Converters.Add(new SearchMetaDataJsonConverter());
            _jsonOptions.Converters.Add(new SectorMarketCapAmountJsonConverter());
            _jsonOptions.Converters.Add(new ShareHoldingDataJsonConverter());
            _jsonOptions.Converters.Add(new ShareHoldingsResponseJsonConverter());
            _jsonOptions.Converters.Add(new UnavailableToTradeJsonConverter());
            _jsonOptions.Converters.Add(new UnsettledProfitJsonConverter());
            _jsonOptions.Converters.Add(new UpdateUserIpRequestJsonConverter());
            _jsonOptions.Converters.Add(new UserFundMarginV3DataJsonConverter());
            _jsonOptions.Converters.Add(new UserIpResponseDataJsonConverter());
            _jsonOptions.Converters.Add(new UserIpResponseJsonConverter());
            ...
            _services.AddSingleton<FundamentalsApiEvents>();
            _services.AddSingleton<HistoryApiEvents>();
            _services.AddSingleton<HistoryV3ApiEvents>();
            _services.AddSingleton<IPOApiEvents>();
            _services.AddSingleton<InstrumentsApiEvents>();
            _services.AddSingleton<LoginApiEvents>();
            _services.AddSingleton<MutualFundApiEvents>();
            _services.AddSingleton<NewsApiEvents>();
            ...
            Action<HttpClient>? client = null, Action<IHttpClientBuilder>? builder = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IFundamentalsApi, FundamentalsApi>(client));
            ...
            builders.Add(_services.AddHttpClient<IIPOApi, IPOApi>(client));
            builders.Add(_services.AddHttpClient<IInstrumentsApi, InstrumentsApi>(client));
            builders.Add(_services.AddHttpClient<ILoginApi, LoginApi>(client));
            builders.Add(_services.AddHttpClient<IMutualFundApi, MutualFundApi>(client));
            builders.Add(_services.AddHttpClient<INewsApi, NewsApi>(client));
