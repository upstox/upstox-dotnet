...
try
{
    var response = await apiInstance.GetMarketQuoteLtpAsync(instrumentKey: "NSE_EQ|INE669E01016");
...
try
{
    var response = await apiInstance.GetMarketQuoteLtpAsync(instrumentKey: "NSE_EQ|INE669E01016,NSE_EQ|INE848E01016");
    Console.WriteLine(response.Ok());
}
catch (Exception e)
{
