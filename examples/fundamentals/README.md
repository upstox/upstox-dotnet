...
Links to all fundamentals-related examples in the `code/` folder.
...
- 2.1 [Get key ratios](code/fundamentals.md#get-key-ratios)

## 3. Balance Sheet

- 3.1 [Get balance sheet](code/fundamentals.md#get-balance-sheet)
...
- 5.1 [Get cash flow](code/fundamentals.md#get-cash-flow)
