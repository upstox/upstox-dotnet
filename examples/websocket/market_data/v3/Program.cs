...
{
    private const string WebSocketUri = "wss://api.upstox.com/v3/feed/market-data-feed";
    ...
    static async Task SendSubscriptionMessage(ClientWebSocket webSocket)
    {
        var message = new
        {
            ...
            {
                mode = "full",
                instrumentKeys = new[] { "NSE_INDEX|Nifty Bank", "NSE_INDEX|Nifty 50", "NSE_EQ|INE669E01016"}
            }
        };
