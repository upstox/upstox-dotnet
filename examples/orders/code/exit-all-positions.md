...
try
{
    var response = await apiInstance.ExitPositionsAsync(tag: null, segment: null);
...
try
{
    var response = await apiInstance.ExitPositionsAsync(tag: null, segment: "NSE_EQ");
    Console.WriteLine(response.Ok());
}
catch (Exception e)
{
...
try
{
    var response = await apiInstance.ExitPositionsAsync(tag: "xyz", segment: null);
    Console.WriteLine(response.Ok());
}
catch (Exception e)
{
